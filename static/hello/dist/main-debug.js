define("hello/dist/main-debug", [ "./spinning-debug", "jquery-debug" ], function(require) {
    var Spinning = require("./spinning-debug");
    var s = new Spinning("#container");
    s.render();
});

define("hello/dist/spinning-debug", [ "jquery-debug" ], function(require, exports, module) {
